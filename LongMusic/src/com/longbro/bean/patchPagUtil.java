...
public class patchPagUtil {
    ...
    public static String patchFile="C:/Users/pc/Desktop/patch20190725.txt";//补丁文件
...
//    public static String classPath="D:/workspace_git/lcfex-loan/target/lcfex-loan/";//class所在路径  
    ...
    public static String outputPath="C:/Users/pc/Desktop/";//生成的增量输出放路径 
      
    public static String version="20190725/";//增量包版本  
    
//    public static String proName="loan/";//项目名称
    public static String proName="bpm/";//项目名称
