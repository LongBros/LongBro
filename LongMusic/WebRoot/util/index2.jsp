<%@page import="com.longbro.bean.Song"%>
<%@page import="com.longbro.service.impl.SongServiceImpl"%>
<%@page import="com.longbro.service.SongService"%>
  ...
  <body>
      <div id="music">
  		<%
  			...
  			String source[]={"http://eng.zy52113.com/music/douyin.mp3","http://eng.zy52113.com/music/love3.mp3",
				...
				"40926193.kw"};
  				...
  				for(int i=0;i<name.length;i++){
	  				if(source[i].contains(".html")){
	  					source[i]="http://link.hhtjim.com/qq/"+source[i].replace("html", "mp3");
	  				}else if(source[i].contains(".kw")){
	  					source[i]="http://link.hhtjim.com/kw/"+source[i].replace("kw", "mp3");
	  				}else if(source[i].contains(".mp3")){
	  					source[i]=source[i];
	  				}else{
	  					source[i]="http://music.163.com/song/media/outer/url?id="+source[i]+".mp3";
	  				}
  					String a="";
  					a="<a href='"+source[i]+"'>"+name[i]+"</a>";
  				%>
  				  <p class="song" style="color: black;" id="music<%=i%>">
	  				  <span><%=i+1%>.</span>
	  				  <%=a%>
  				  </p>
  				<%
