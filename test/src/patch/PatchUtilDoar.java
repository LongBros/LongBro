 ...
 */
public class PatchUtilDoar {

    public static String patchFile = "C:/Users/pc/Desktop/packet/2020-04-221.txt";//补丁文件:记录更新文件的项目路径，如:src/main/java/com/redxun/sys/core/controller/SysAccountFormController.java
...
//    public static String classPath="D:/alc201910171/lcfex-mortgageBusiness/target/lcfex-mortgageBusiness/";//class所在路径:从WEB-INF开始
    ...
    public static String version = "2020-04-221";//增量包版本:以当前日期作为版本号
